...
| [**Hooks**](https://x.com/LLMJunky/status/2031582374064951414) | `.codex/hooks/` | [![Implemented](!/tags/implemented.svg)](https://github.com/shanraisshan/codex-cli-voice-hooks) User-defined shell scripts that run on specific events — notifications, sound feedback, and custom automation |
